...
const Hero = () => {
  return (
    <div className='mb-10'>
      ...
      <h6 className='text-base text-muted-foreground dark:text-[#A1A1A1] pt-3'>{Data.age}y/o Tech Enthusiast, {Data.address.country}</h6>
      <div className='mt-5 xl:w-3/4'>
        <h6 className='text-base text-muted-foreground dark:text-[#A1A1A1]'>{Data.description}</h6>
      </div>
      <div className='mt-5'>
        <h6 className='text-base text-muted-foreground dark:text-[#A1A1A1]'>Feel free to reach me out at&nbsp;
      ...
      <div className='mt-4 flex flex-row'>
        <h6 className='text-base text-muted-foreground dark:text-[#A1A1A1]'>View my&nbsp;
