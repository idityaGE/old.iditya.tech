...
- [Setup Instructions](#toolbox-setup-instructions)
- [Usage](#page_with_curl-usage)
...
- Exclude unnecessary sections during PDF generation.
- Utilize \`html2canvas\` to capture the DOM and convert it to images.
- Use \`jsPDF\` to combine images into a single PDF file with adjustable page sizes.

## :camera: Screenshots

![Realtime Preview](/.github/images/img1.png "Realtime Preview")

![Adding More Questions](/.github/images/img2.png "Adding More Questions")
...
- You can customize the layout of the generated PDF, including:
  ...
  - **Page Size**: The page size is dynamically set based on the content size. If you want a fixed page size, modify the \`jsPDF\` constructor to use fixed dimensions.
